            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-secondary navbar-dark">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="{{route('admin.tables')}}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Tables</a>
                    </div>
                </nav>
            </div>
            <div class="content">
                    ...
                    <div class="bg-secondary rounded-top p-4">
                        <div class="row">
                            <div class="col-12 col-sm-6 text-center text-sm-start">
                                &copy; <a href="#" style="color:#ffffff">Your Site Name</a>, All Right Reserved. 
                            </div>
                            <div class="col-12 col-sm-6 text-center text-sm-end">
                                ...
                                <br>Distributed By: <a href="https://themewagon.com" target="_blank" style="color:#ffffff">ThemeWagon</a>
                            </div>
                        </div>
                    </div>
                </div>
